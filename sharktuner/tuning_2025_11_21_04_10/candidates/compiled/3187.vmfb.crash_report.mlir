    ...
    hal.executable.variant public @rocm_hsaco_fb target(#executable_target_rocm_hsaco_fb) {
      ...
      builtin.module {
        func.func @main_dispatch_0_matmul_1024x10240x1280_f16xf16xf32() {
          ...
          %4 = hal.interface.binding.subspan layout(#pipeline_layout) binding(2) alignment(64) offset(%c0) flags(Indirect) : memref<1024x10240xf32, #hal.descriptor_type<storage_buffer>>
          ...
          %10 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"]} ins(%6, %7 : tensor<1024x1280xf16>, tensor<10240x1280xf16>) outs(%9 : tensor<1024x10240xf32>) {
