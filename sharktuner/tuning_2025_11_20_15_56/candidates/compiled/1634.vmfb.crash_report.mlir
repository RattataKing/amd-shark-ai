    ...
    hal.executable.variant public @rocm_hsaco_fb target(#executable_target_rocm_hsaco_fb) {
      ...
      builtin.module {
        func.func @main_dispatch_0_matmul_512x512x512_f16xf16xf32() {
          ...
          %0 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c0) flags("ReadOnly|Indirect") : memref<512x512xf16, #hal.descriptor_type<storage_buffer>>
          ...
          %2 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c0) flags("ReadOnly|Indirect") : memref<512x512xf16, #hal.descriptor_type<storage_buffer>>
          ...
          %4 = hal.interface.binding.subspan layout(#pipeline_layout) binding(2) alignment(64) offset(%c0) flags(Indirect) : memref<512x512xf32, #hal.descriptor_type<storage_buffer>>
          ...
          %10 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"]} ins(%6, %7 : tensor<512x512xf16>, tensor<512x512xf16>) outs(%9 : tensor<512x512xf32>) {
