    ...
    hal.executable.variant public @rocm_hsaco_fb target(#executable_target_rocm_hsaco_fb) {
      ...
      builtin.module {
        func.func @main_dispatch_0_matmul_2048x1280x1280_f16xf16xf32() {
          ...
          %10 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"]} ins(%6, %7 : tensor<2048x1280xf16>, tensor<1280x1280xf16>) outs(%9 : tensor<2048x1280xf32>) {
